...
<div class="col-md-12 col-xs-12">
    ...
    <div class="widget-body">
        ...
        <div class="table-responsive">
            <table class="table table-bordered table-condensed" cellspacing="0" cellpadding="0" style="width: <?php echo (count($columns)*250); ?>px">
                ...
                <tr>
                    <td colspan="<?php echo count($columns)-2;?>">
                        ...
                        <a href="plugin.php?page=MantisKanban/kanban_page&sort=last_updated" <?php if($f_sort_by == 'last_updated') {?> class="bold"<?php }?>>
                            <?php echo plugin_lang_get( 'sort_date_modified' );?></a> |
